...
namespace logic{
    ...
    public:
         ...
         */
        Partition(unsigned long blockSize, unsigned long amountBlocks, IFileSystem* fileSystem);
         ...
         */
        bool format(unsigned long blockSize, unsigned long amountBlocks, IFileSystem* fileSystem);
        ...
        /**
         * gets an iterator to the first block in the partition
         * @return get start of type iterator for block list
         */

        std::vector<logic::Block* >::iterator getStart();
