...
public:
    ...
    bool changeFileAtributs(File* oldFile,File* newFile);

    bool changeFileAtributs(std::string path,File* newFile);

    bool changeFileContent(File* file , FileData* newData);

    bool changeFileContent(std::string path , FileData* newData);
