...
namespace core {
    ...
    private:
        ...
        /**
         * @brief data_m This is the actual data, its size is block size * 1byte
         */
        unsigned char* data_m;

        /**
         * @brief blockSize_m This variable determines the size of this block
         */
        unsigned long blockSize_m;

        /**
         * @brief state_m This is the current state of this block, @see Definitions.h
         */
        block_state state_m;
