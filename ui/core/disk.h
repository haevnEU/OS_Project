...
namespace core {
    ...
    namespace disk{
        ...
        public:
             ...
             */
            Disk( unsigned long long capacity, std::string name);
             ...
             * @param name This argument will be assigned to name_m and specify the manufcator name
             */
            Disk( unsigned long long capacity, const char* name);

            /**
             * @brief capacity This method returns the disk capacity
             * @return capacity_m
             */
             unsigned long long capacity(void);
