...
FileSystem::FileSystem(unsigned long int blockSize, unsigned long int blockCount, std::vector<logic::Block *> * startBlock,char separator):blockCount_m(blockCount),blockSize_m(blockSize),startBlock(startBlock),separator(separator) {
